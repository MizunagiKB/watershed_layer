...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.slider_overlay.setTickInterval(0)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/res/res/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/res/res/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileSave.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/res/res/arrow_refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ViewAutoUpdate.setIcon(icon3)
        self.action_ViewAutoUpdate.setObjectName("action_ViewAutoUpdate")
        self.action_EditColor = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/res/res/color_wheel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_EditColor.setIcon(icon4)
        self.action_EditColor.setObjectName("action_EditColor")
        self.action_FileExportPicture = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/res/res/picture_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileExportPicture.setIcon(icon5)
        self.action_FileExportPicture.setObjectName("action_FileExportPicture")
        self.action_FileSaveAs = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/res/res/disk_multiple.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileSaveAs.setIcon(icon6)
        self.action_FileSaveAs.setObjectName("action_FileSaveAs")
        self.action_FileImportPicture = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/res/res/folder_picture.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileImportPicture.setIcon(icon7)
        ...
        self.action_EditPin = QtWidgets.QAction(MainWindow)
        self.action_EditPin.setCheckable(True)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/res/res/shape_square_edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_EditPin.setIcon(icon8)
        self.action_EditPin.setObjectName("action_EditPin")
        self.action_EditPan = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/res/res/shape_square.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_EditPan.setIcon(icon9)
        self.action_EditPan.setObjectName("action_EditPan")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_EditPin.setText(_translate("MainWindow", "EditPin"))
        self.action_EditPin.setToolTip(_translate("MainWindow", "EditPin"))
        self.action_EditPan.setText(_translate("MainWindow", "EditPan"))
        self.action_EditPan.setToolTip(_translate("MainWindow", "EditPan"))
        self.action_EditPan.setShortcut(_translate("MainWindow", "Space"))
