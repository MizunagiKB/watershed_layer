...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/res/res/layers.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dockwidget_layer.setWindowIcon(icon)
        ...
        self.slider_overlay.setFocusPolicy(QtCore.Qt.NoFocus)
        self.slider_overlay.setMaximum(100)
        self.slider_overlay.setSingleStep(10)
        ...
        self.slider_overlay.setTickInterval(10)
        ...
        self.horizontalLayout.setContentsMargins(-1, 3, 3, -1)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.tb_layer_append = QtWidgets.QToolButton(self.dockWidgetContents_4)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/res/res/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tb_layer_append.setIcon(icon1)
        self.tb_layer_append.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.tb_layer_append.setObjectName("tb_layer_append")
        self.horizontalLayout.addWidget(self.tb_layer_append)
        self.tb_layer_remove = QtWidgets.QToolButton(self.dockWidgetContents_4)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/res/res/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tb_layer_remove.setIcon(icon2)
        self.tb_layer_remove.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.tb_layer_remove.setObjectName("tb_layer_remove")
        self.horizontalLayout.addWidget(self.tb_layer_remove)
        ...
        self.slider_g.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.slider_b.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.slider_r.setBaseSize(QtCore.QSize(0, 0))
        self.slider_r.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/res/res/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileOpen.setIcon(icon3)
        self.action_FileOpen.setIconText("Open")
        ...
        self.action_FileSave.setEnabled(True)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/res/res/disk.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileSave.setIcon(icon4)
        self.action_FileSave.setStatusTip("")
        ...
        self.action_ViewAutoUpdate.setCheckable(True)
        self.action_ViewAutoUpdate.setChecked(True)
        self.action_ViewAutoUpdate.setEnabled(False)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/res/res/arrow_refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ViewAutoUpdate.setIcon(icon5)
        self.action_ViewAutoUpdate.setObjectName("action_ViewAutoUpdate")
        self.action_EditColor = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/res/res/color_wheel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_EditColor.setIcon(icon6)
        self.action_EditColor.setObjectName("action_EditColor")
        self.action_FileExportPicture = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/res/res/picture_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileExportPicture.setIcon(icon7)
        self.action_FileExportPicture.setObjectName("action_FileExportPicture")
        self.action_FileSaveAs = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/res/res/disk_multiple.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileSaveAs.setIcon(icon8)
        self.action_FileSaveAs.setObjectName("action_FileSaveAs")
        self.action_FileImportPicture = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/res/res/folder_picture.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_FileImportPicture.setIcon(icon9)
        ...
        self.menuFile.addAction(self.action_FileOpen)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_FileImportPicture)
        self.menuFile.addAction(self.action_FileExportPicture)
        self.menuFile.addAction(self.action_FileSave)
        self.menuFile.addAction(self.action_FileSaveAs)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_FileQuit)
        self.menuEdit.addAction(self.action_EditColor)
        self.menuView.addAction(self.action_ViewOriginal)
        self.menuView.addAction(self.action_ViewOverlay)
        self.menuView.addAction(self.action_ViewWatershed)
        self.menuBar.addAction(self.menuFile.menuAction())
        self.menuBar.addAction(self.menuEdit.menuAction())
        self.menuBar.addAction(self.menuView.menuAction())

        self.retranslateUi(MainWindow)
        self.action_FileQuit.triggered.connect(MainWindow.close)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Watershed Layer"))
        self.dockwidget_layer.setWindowTitle(_translate("MainWindow", "Layer Information"))
        self.label.setText(_translate("MainWindow", "Overlay Level"))
        self.tb_layer_append.setStatusTip(_translate("MainWindow", "レイヤーの追加"))
        self.tb_layer_append.setText(_translate("MainWindow", "Append"))
        self.tb_layer_remove.setStatusTip(_translate("MainWindow", "レイヤーの削除"))
        self.tb_layer_remove.setText(_translate("MainWindow", "Remove"))
        ...
        self.action_FileOpen.setStatusTip(_translate("MainWindow", "watershedファイルの読込"))
        ...
        self.action_ViewWatershed.setStatusTip(_translate("MainWindow", "Watershed画像の表示"))
        self.action_ViewAutoUpdate.setText(_translate("MainWindow", "ViewAutoUpdate"))
        self.action_ViewAutoUpdate.setStatusTip(_translate("MainWindow", "プレビューの自動更新"))
        self.action_EditColor.setText(_translate("MainWindow", "Color"))
        self.action_EditColor.setStatusTip(_translate("MainWindow", "レイヤーカラーの変更"))
        self.action_FileExportPicture.setText(_translate("MainWindow", "Export Picture..."))
        self.action_FileExportPicture.setStatusTip(_translate("MainWindow", "画像の出力"))
        self.action_FileSaveAs.setText(_translate("MainWindow", "SaveAs..."))
        self.action_FileSaveAs.setStatusTip(_translate("MainWindow", "watershedファイルに名前をつけて保存"))
        self.action_FileImportPicture.setText(_translate("MainWindow", "Import Picture..."))
        self.action_FileImportPicture.setStatusTip(_translate("MainWindow", "画像の入力"))
        ...
        self.action_ViewOriginal.setStatusTip(_translate("MainWindow", "Original画像の表示"))
        ...
        self.action_ViewOverlay.setStatusTip(_translate("MainWindow", "Original + Watershed画像の表示"))
import resource_rc
